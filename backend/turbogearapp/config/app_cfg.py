# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in turbogear-app.
...
import turbogearapp
from turbogearapp import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': turbogearapp.model,
    'DBSession': turbogearapp.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "3e9b6113-475f-41cd-99ed-99ae9533d9d9",
